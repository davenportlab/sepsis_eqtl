...
# for CHR in {1..23}
# do
# python eigenMT_update.py --CHROM $CHR --QTL eQTL_results_for_eigenMT_chr$CHR.txt --GEN geno_for_eigenMT_chr$CHR.txt --GENPOS geno_pos_for_eigenMT_chr$CHR.txt --OUT eigenMT_chr$CHR --window 200 --PHEPOS gene_pos_for_eigenMT_chr$CHR.txt --cis_dist 1000000
# done
