...
# PCA plot: project GAinS samples onto 1000 genomes
# https://www.kingrelatedness.com/ancestry/index.shtml
# king -b KGref.bed,GAinS_for_PCA_1KGP.bed --pca --projection --rplot
...
dat$Population[is.na(dat$Population)] <- "GAinS"

pdf("FigS2A_GAinS_projected_onto_1kgp.pdf", width=6, height=5)
ggplot(dat, aes(PC1, PC2, colour=Population)) +
  geom_point() +
  theme_bw()
dev.off()
...
# png("Fig_S2B_SRS1ever_qqplot.png")
qq(srs1ever.plink$P)
# dev.off()
